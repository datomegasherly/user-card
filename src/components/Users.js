                                ...
                                <div data-test="user-box-component" key={user.username} className="col-xs-12 col-sm-6 col-md-4 col-lg-3 pt-2 pr-1 pl-1">
                                    <div className="card h6">
                                        ...
                                        <div className="text-right">
                                            <Link to={`/user/edit/${user._id}`}><button className="ml-2 mb-2 btn btn-warning btn-sm">Edit</button></Link>
                                            <Link to={`/user/delete/${user._id}`}><button className="ml-2 mr-2 mb-2 btn btn-danger btn-sm">Delete</button></Link>
                                        </div>
                                    </div>
                                </div>
                            )
